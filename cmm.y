...
%token _SYMB_13    //   if
%token _SYMB_14    //   int
%token _SYMB_15    //   repeat
%token _SYMB_16    //   return
%token _SYMB_17    //   until
...
Stm : Decl _SYMB_0 {  $$ = new SDecl($1); YY_RESULT_Stm_= $$; } 
  ...
  | _SYMB_18 _SYMB_1 Exp _SYMB_2 Stm {  $$ = new SWhile($3, $5); YY_RESULT_Stm_= $$; }
  | _SYMB_16 Exp _SYMB_0 {  $$ = new SReturn($2); YY_RESULT_Stm_= $$; }
  | _SYMB_13 _SYMB_1 Exp _SYMB_2 Stm {  $$ = new SIf($3, $5); YY_RESULT_Stm_= $$; }
  | _SYMB_13 _SYMB_1 Exp _SYMB_2 Stm _SYMB_12 Stm {  $$ = new SIfElse($3, $5, $7); YY_RESULT_Stm_= $$; }
  | _SYMB_13 _SYMB_1 Exp Exp _SYMB_2 Stm {  $$ = new SFor2($3, $4, $6); YY_RESULT_Stm_= $$; }
  | _SYMB_15 Stm _SYMB_17 _SYMB_1 Exp _SYMB_2 _SYMB_0 {  $$ = new SRepeat($2, $5); YY_RESULT_Stm_= $$; }
;
...
;
Type : _SYMB_14 {  $$ = new TInt(); YY_RESULT_Type_= $$; } 
